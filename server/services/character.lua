...
function CharacterAPI.CreateCharacter(userid, roldid, firstname, lastname, model, dob, dollars, gold, tokens, xp, x, y, z, lang,clothing,attributes)
    CharacterController.CreateCharacter(userid, roldid, firstname, lastname, model,dob, dollars, gold, tokens, xp, x, y, z,
