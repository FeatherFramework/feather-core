...
Config.densityMultipliers.ambientAnimals  = 1.0
Config.densityMultipliers.ambientHumans   = 1.0
Config.densityMultipliers.scenarioAnimals = 1.0
Config.densityMultipliers.scenarioHumans  = 1.0