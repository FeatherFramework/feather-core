...
RegisterCommand('getTaming', function()
  print('Taming Level', MyHorse:GetHorseTamingState())
end)

RegisterCommand('getPelt', function()
  MyHorse:GetPeltFromHorse(1)
end)

RegisterCommand('clearPelt', function()
  MyHorse:ClearPeltFromHorse(1)
end)

RegisterCommand('agitate1', function()
  MyHorse:AgitateHorse(false)
end)

RegisterCommand('agitate2', function()
  MyHorse:AgitateHorse(true)
end)
...
RegisterCommand('avoidance1', function()
  MyHorse:SetAvoidanceLevel(0)
end)

RegisterCommand('avoidance2', function()
  MyHorse:SetAvoidanceLevel(1)
end)

RegisterCommand('avoidance3', function()
  MyHorse:SetAvoidanceLevel(2)
end)

RegisterCommand('avoidance0', function()
  MyHorse:ResetAvoidanceLevel()
end)

RegisterCommand('getMaxStam', function()
  print(MyHorse:GetMaxStamina())
end)

RegisterCommand('getStam', function()
  print(MyHorse:GetStamina())
end)

RegisterCommand('getStamRegen', function()
  print(MyHorse:GetStaminaDepletionMultiplier())
end)

RegisterCommand('setStamRegen', function()
  MyHorse:SetStaminaDepletionMultiplier(50.0)
end)


RegisterCommand('getMaxHP', function()
  print(MyHorse:GetMaxHealth())
end)

RegisterCommand('getStam', function()
  MyHorse:SetMaxHealth(MyHorse:GetMaxHealth() * 2)
end)
...
RegisterCommand('getCoreVal', function()
  print('HP', MyHorse:GetCoreValue(0))
  print('Stamina', MyHorse:GetCoreValue(1))
end)

RegisterCommand('setCoreVal', function()
  MyHorse:SetCoreValue(0, 100)
  MyHorse:SetCoreValue(1, 100)
end)
